...
\setbackgroundpictureblack{tom-evans/student-response.png}
\begin{frame}[nofills,label=video]
  \color{gray}
  \vfill
  \vfill
  \begin{center}
    \url{http://youtu.be/KB_w1qWoT3I}
  \end{center}
  \vfill
\end{frame}
...
\vfill
\textbf{\uncover<1->{\hfill\alt<1>{Cheaper?}{\textcolor{gray}{\sout{Cheaper?}}}}%
\textbf{\hfill\uncover<2->{\textcolor{red!50!black}{Better!}}\hfill\null}}
\vfill
